                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.all(12.0),
                        child: Text(
                          'Hayvan Dostu 2022 yılında Konya da Yiğit Kirpi tarafından kuruldu. Amacımız insanların hayvanları için'
                          'en doğru, en uygun fiyatlı ürünleri bulmasını sağlamak. ',
                      ...
                      Padding(
                        padding: const EdgeInsets.all(12.0),
                        child: Text(
                          '1. Sahipsiz hayvanlara mama yardımı ve onlara yeni yuva bulmak,',
                          style: TextStyle(fontSize: 17),
                        ),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(12.0),
                        child: Text(
                          '2. İnsanların daha çok evcil hayvan sahiplenmesini sağlamak.',
                          style: TextStyle(fontSize: 17),
                        ),
                      ),
                      Padding(
