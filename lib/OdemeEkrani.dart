              ...
              children: [
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: (){
                      if(kartTarih.text==''&&kartNumara.text==''&&kartIsim.text==''&&cvc.text==''){
                        showDialog<String>(
                          context: context,
                      ...
                      else if(kartNumara.text.length!=16 || cvc.text.length!=3){
                        showDialog<String>(
                          context: context,
                          builder: (BuildContext context) => AlertDialog(
                            content: const Text('Tüm alanlar uygun formatta doldurulmalıdır!!!!!',style: TextStyle(color: Colors.white),),
                            backgroundColor: Colors.indigo[500],
                            elevation: 24.0,
                            actions: <Widget>[
                              TextButton(
                        ...
                        showDialog<String>(
                          context: context,
                          builder: (BuildContext context) => AlertDialog(
                            content: const Text('Ödeme Başarı ile Tamamlandı!!!!!',style: TextStyle(color: Colors.white),),
                            backgroundColor: Colors.indigo[500],
                            elevation: 24.0,
                            actions: <Widget>[
                              TextButton(
